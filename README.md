...
| <a name="input_managed_instance_action"></a> [managed\_instance\_action](#input\_managed\_instance\_action) | Managed instance action. With type: 'pause', 'resume', 'recycle' | `list(map(string))` | `[]` | no |
